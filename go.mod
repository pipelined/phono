...
require (
	...
	github.com/pipelined/mock v0.0.0-20190416005704-852ac2fd22a9 // indirect
	github.com/pipelined/mp3 v0.0.0-20190514061637-1a80ec07369b
	github.com/pipelined/pipe v0.4.0
	github.com/pipelined/signal v0.0.0-20190411172221-40f38ff7f90f
	github.com/pipelined/wav v0.0.0-20190514181225-804e685d5294
